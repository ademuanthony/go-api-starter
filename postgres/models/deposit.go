...
var DepositWhere = struct {
	...
	Ref:       whereHelperstring{field: "\"deposit\".\"ref\""},
}
...
var (
	depositAllColumns            = []string{"id", "amount", "account_id", "date", "ref"}
	depositColumnsWithoutDefault = []string{"id", "amount", "account_id", "date", "ref"}
