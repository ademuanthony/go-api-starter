...
var WithdrawalWhere = struct {
	...
	Destination: whereHelperstring{field: "\"withdrawal\".\"destination\""},
	Ref:         whereHelperstring{field: "\"withdrawal\".\"ref\""},
	Status:      whereHelperstring{field: "\"withdrawal\".\"status\""},
}
...
var (
	withdrawalAllColumns            = []string{"id", "account_id", "amount", "date", "destination", "ref", "status"}
	withdrawalColumnsWithoutDefault = []string{"id", "account_id", "amount", "date", "destination", "ref", "status"}
	withdrawalColumnsWithDefault    = []string{}
