...
var (
	notificationDBTypes = map[string]string{`ID`: `character varying`, `AccountID`: `character varying`, `Status`: `integer`, `Title`: `character varying`, `Content`: `character varying`, `Type`: `integer`, `ActionLink`: `character varying`, `ActionText`: `character varying`, `Date`: `bigint`}
	_                   = bytes.MinRead
)
