...
const (
	defaultConfigFilename = "app.conf"
	sampleConfigFileName  = "./sample-app.conf"
...
var (
	...
	defaultServerHeader       = "app"
)

type Config struct {
	// General application behavior
	Environment  string `long:"environment" description:"Environment (development, staging, production)" env:"ENVIRONMENT"`
	HomeDir      string `short:"A" long:"appdata" description:"Path to application home directory" env:"DEFIPAY_APPDATA_DIR"`
	ConfigFile   string `short:"C" long:"configfile" description:"Path to configuration file" env:"DEFIPAY_CONFIG_FILE"`
	DataDir      string `short:"b" long:"datadir" description:"Directory to store data" env:"DEFIPAY_DATA_DIR"`
	LogDir       string `long:"logdir" description:"Directory to log output." env:"DEFIPAY_LOG_DIR"`
	...
	OutFolder    string `short:"f" long:"outfolder" description:"Folder for file outputs" env:"DEFIPAY_OUT_FOLDER"`
	ShowVersion  bool   `short:"V" long:"version" description:"Display version information and exit"`
	TestNet      bool   `long:"testnet" description:"Use the test network (default mainnet)" env:"DEFIPAY_USE_TESTNET"`
	SimNet       bool   `long:"simnet" description:"Use the simulation test network (default mainnet)" env:"DEFIPAY_USE_SIMNET"`
	DebugLevel   string `short:"d" long:"debuglevel" description:"Logging level {trace, debug, info, warn, error, critical}" env:"DEFIPAY_LOG_LEVEL"`
	Quiet        bool   `short:"q" long:"quiet" description:"Easy way to set debuglevel to error" env:"DEFIPAY_QUIET"`
	HTTPProfile  bool   `long:"httpprof" short:"p" description:"Start HTTP profiler." env:"DEFIPAY_ENABLE_HTTP_PROFILER"`
	HTTPProfPath string `long:"httpprofprefix" description:"URL path prefix for the HTTP profiler." env:"DEFIPAY_HTTP_PROFILER_PREFIX"`
	CPUProfile   string `long:"cpuprofile" description:"File for CPU profiling." env:"DEFIPAY_CPU_PROFILER_FILE"`
	UseGops      bool   `short:"g" long:"gops" description:"Run with gops diagnostics agent listening. See github.com/google/gops for more information." env:"DEFIPAY_USE_GOPS"`
	...
	// API/server
	APIProto           string `long:"apiproto" description:"Protocol for API (http or https)" env:"DEFIPAY_ENABLE_HTTPS"`
	APIListen          string `long:"apilisten" description:"Listen address for API. default localhost:7777, :17778 testnet, :17779 simnet" env:"API_LISTEN_URL"`
